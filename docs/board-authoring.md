...
4. 공식 웹사이트 주소를 입력하고 기업 CI를 업로드합니다. 이미지 비율은 자동으로 유지되며 흰색 CI는 검정 표시 옵션을 켤 수 있습니다. 미등록 CI는 투명한 자리표시자로 남고 미등록 링크는 표시하지 않습니다.
5. **초안 / 비공개**를 끄고 저장하면 배포 후 공개됩니다. 게시를 내릴 때는 다시 켜고 저장합니다.
